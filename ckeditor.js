...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var b = {timestamp: "D6IE", version: "4.2", revision: "f74e558", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: []}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return{define: function (a, d) {
            ...
            function i(b, g, n, o) {
                b = {name: a, sender: this, editor: b, data: g, listenerData: c, stop: n, cancel: o, removeListener: l};
    ...
    CKEDITOR.dtd = function () {
        var b = CKEDITOR.tools.extend, c = function (a, b) {
            ...
            return e
        }, a = {}, e = {}, d = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1}, h = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, f = {}, j = {"#": 1}, i = {center: 1, dir: 1, noframes: 1};
        ...
        c = {a: c(a, {a: 1, button: 1}), abbr: a, address: e,
            ...
            sub: a, summary: a, sup: a, table: {caption: 1, colgroup: 1, thead: 1, tfoot: 1, tbody: 1, tr: 1}, tbody: {tr: 1}, td: e, textarea: j, tfoot: {tr: 1}, th: e, thead: {tr: 1}, time: c(a, {time: 1}), title: j, tr: {th: 1, td: 1}, track: f, u: a, ul: {li: 1}, "var": a, video: b({source: 1, track: 1}, e), wbr: f, acronym: a, applet: b({param: 1}, e), basefont: f, big: a, center: e, dialog: f, dir: {li: 1}, font: a, isindex: f, noframes: e, strike: a, tt: a};
    ...
    (function () {
        ...
        }, h = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, f = CKEDITOR.dom.walker.bogus(), j = new CKEDITOR.dom.walker.whitespaces, i = new CKEDITOR.dom.walker.bookmark, l = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/;
        CKEDITOR.dom.range.prototype = {clone: function () {
            ...
            return{start: b.getAddress(a),
                end: p ? null : c.getAddress(a), startOffset: d, endOffset: g, normalized: a, collapsed: p, is2: true}
    ...
    (function () {
        ...
        function e(a) {
            ...
            return a._.filterFunction = function (g, f, e, h, k, m, t) {
                ...
                if (f) {
                    var o = g.name, e = f.elements[o], j = f.generic, f = {valid: false, validAttributes: {}, validClasses: {}, validStyles: {},
        ...
        CKEDITOR.filter.prototype = {allow: function (b, c, g) {
            ...
            if (typeof a == "string") {
                ...
                d = {name: g.element, attributes: o, classes: o["class"] ?
        ...
        var s = {styles: 1, attributes: 1, classes: 1}, C = {styles: "requiredStyles", attributes: "requiredAttributes",
            classes: "requiredClasses"}, y = /^([a-z0-9*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i, t = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, w = CKEDITOR.filter.transformationsTools = {sizeToStyle: function (a) {
    ...
    (function () {
        CKEDITOR.lang = {languages: {af: 1, ar: 1, bg: 1, bn: 1, bs: 1, ca: 1, cs: 1, cy: 1, da: 1, de: 1, el: 1, "en-au": 1, "en-ca": 1, "en-gb": 1, en: 1, eo: 1, es: 1, et: 1, eu: 1, fa: 1, fi: 1, fo: 1, "fr-ca": 1, fr: 1, gl: 1, gu: 1, he: 1, hi: 1, hr: 1, hu: 1, id: 1, is: 1, it: 1, ja: 1, ka: 1, km: 1, ko: 1, ku: 1, lt: 1, lv: 1, mk: 1, mn: 1, ms: 1, nb: 1, nl: 1, no: 1, pl: 1, "pt-br": 1, pt: 1, ro: 1, ru: 1, si: 1, sk: 1, sl: 1, sq: 1, "sr-latn": 1, sr: 1, sv: 1, th: 1, tr: 1, ug: 1, uk: 1, vi: 1, "zh-cn": 1, zh: 1}, load: function (b, c, a) {
    ...
    CKEDITOR.resourceManager.prototype = {add: function (b, c) {
        ...
        CKEDITOR.scriptLoader.load(h, function (b, d) {
    ...
    (function () {
        ...
        var E = /(?:&nbsp;|\xa0)$/, A = "{cke_protected}", r = CKEDITOR.dtd, x = ["caption", "colgroup", "col", "thead", "tfoot", "tbody"], z = CKEDITOR.tools.extend({}, r.$blockLimit, r.$block), s = {elements: {}, attributeNames: [
            [/^on/, "data-cke-pa-on"]
        ]}, C = {elementNames: [
            [/^cke:/, ""],
            [/^\?xml:namespace$/, ""]
    ...
    (function () {
        ...
        var n = function () {
            ...
            var i = CKEDITOR.dtd, m = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, j = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({}, i.$inline);
            delete n.br;
            return function (m, l, z) {
                ...
                if (!C.checkReadOnly()) {
                    var t = (new CKEDITOR.dom.elementPath(C.startContainer,
                        C.root)).blockLimit || C.root, l = {type: l, dontFilter: y, editable: m, editor: s, range: C, blockLimit: t, mergeCandidates: [], zombies: []}, s = l.range, y = l.mergeCandidates, w, I, G, D;
    ...
    CKEDITOR.plugins.add("wsc", {requires: "dialog", parseConfig: function (a) {
