<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="http://<?php echo $_SERVER['SERVER_NAME'];?>/backend/paging/css/style.css" media="screen"/>
	</head>
	<div class="header"> 
	...
	<div class="menu">
		...
		<input onClick="document.listExamQuestion.submit()" title="l&ouml;schen" class="cmsIcon" src="../../icons/delete_32.png" name="delete" type="image">
		<form method="post" name="add" action="http://<?php echo $_SERVER['SERVER_NAME']; ?>/index2.php?action=add&amp;page=1">
			...
			<?php 
				foreach($data as $row) {
					...
					<tr>
						...
						<td>
							<button onclick="location.href = '/index2.php?action=edit&id=<?php echo $row['id']; ?>';" class="cmsIcon" style="border: 0; background: transparent" type="button" title="bearbeiten">
