...
<script type="text/javascript"
        src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/backend/View/paging/jquery-1.3.2.js"></script>
<script src="http://<?php echo $_SERVER['SERVER_NAME']; ?>/backend/View/paging/jquery.paginate.js"
